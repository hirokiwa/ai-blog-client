  ...
  return scrollY < 10 || isScrolling ? null : (
    <div className="flex-col items-center relative">
      <button
        ...
        title="ページトップへ"
        aria-label="ページトップへ"
        className="bg-pink-600 rounded-full flex items-center justify-center p-4 shadow-xl group opacity-100 hover:opacity-80 focus:opacity-80 hover:shadow-2xl focus:shadow-2xl transition-all duration-150 ease-[cubic-bezier(.17,.67,.83,.67)]"
      >
